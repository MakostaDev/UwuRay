...
func NewSniffer(ctx context.Context) *Sniffer {
	ret := &Sniffer{
		sniffer: []protocolSnifferWithMetadata{
			{func(c context.Context, b []byte) (SniffResult, error) { return bittorrent.SniffHTTPtcp(b, c) }, false, net.Network_TCP},
			...
			{func(c context.Context, b []byte) (SniffResult, error) { return bittorrent.SniffHTTPudp(b, c) }, false, net.Network_UDP},
		},
	}
